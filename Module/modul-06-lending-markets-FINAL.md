...
**Lektionsanzahl:** 6
**Didaktische Ausrichtung:** Lending-Mechanik, Zinskurven, Aave/Compound/Morpho, Supply-Strategien, Risiko-Monitoring
...
- Supply, Borrow, Collateral (Sicherheiten)
- Loan-to-Value (LTV), Liquidation Threshold, Liquidation Penalty
- Health Factor (HF)
- Utilization Rate, Interest Rate Model (Kink)
- Collateral Ratio
- aToken / cToken (Yield-bearing Token)
- Smart Contract Risk, Oracle Risk, Liquidation Risk
- Total Value Locked (TVL)

**Querverweise:**
- Health-Factor-Walkthrough und Liquidations-Beispiele sind modulspezifische Fix-Doc-Erweiterungen; der Health Factor wird in Lektion 6.3 konkret am Aave-Dashboard eingeführt und in **Modul 7 (Sicherheiten & Liquidationen)** tiefgehend behandelt (Cascade-Szenarien, Oracle-Failure).
- Morpho als Protokoll wird in Lektion 6.4 vorgestellt; Leverage-Loops auf Lending-Basis folgen in **Modul 10**.
...
- Die Utilization Rate als zentralen Marktzustands-Indikator in eigenen Positionen aktiv überwachen
- Den Supply-APY aus Borrow-APY und Utilization rechnerisch herleiten
- Typische Utilization-Profile verschiedener Märkte (Stablecoin-Markt, ETH-Markt, Long-Tail-Markt) in ihrer Ertragsstruktur unterscheiden
