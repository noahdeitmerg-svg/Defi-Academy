...
**Kursstufe:** Core (Fortgeschrittene Lending-Mechanik)
**Lektionsanzahl:** 6
**Didaktische Ausrichtung:** Collateral-Mechanik, Health Factor, Liquidationsabläufe, Oracle-Risiken, Kaskaden, Borrow-Hygiene
...
- Collateral, Collateral Ratio, Loan-to-Value (LTV)
- Liquidation Threshold, Liquidation Penalty, Close Factor
- Health Factor (HF)
- Oracle, Oracle Price, Oracle Failure
- Liquidation Cascade / Kaskaden-Liquidation
- Keeper / Liquidator Bot
- Smart Contract Risk, Oracle Risk, Liquidation Risk, Composability Risk
- Total Value Locked (TVL)

**Querverweise:**
- Cascade-Liquidations-Szenarien und Oracle-Failure-Case-Studies sind modulspezifische Fix-Doc-Erweiterungen und werden in Lektion 7.4 (Oracle-Risiken) und 7.5 (Kaskaden) explizit didaktisch aufbereitet.
- Der Health Factor wurde in Modul 6 eingeführt und wird hier in Lektion 7.2 vertieft, inklusive Rechenbeispielen und Überwachungspraxis.
- Leverage-Loops auf Basis dieser Mechanik werden in Modul 10 behandelt.
...
- Oracle-Failure-Szenarien (verzögerte Preise, manipulierte Pools, Netzwerk-Congestion) als systemische Risiko-Quelle analysieren
- Historische Oracle-Failure-Events als Fallbeispiele verstehen und auf eigene Positionen übertragen
- Chainlink, Uniswap-TWAP und Redstone als unterschiedliche Oracle-Designs nach Sicherheit und Latenz bewerten
