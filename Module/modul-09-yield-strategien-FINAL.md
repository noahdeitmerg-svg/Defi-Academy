...
**Kursstufe:** Advanced (Strukturierte Rendite-Strategien)
**Lektionsanzahl:** 6
**Didaktische Ausrichtung:** Staking, Liquid Staking, Restaking, Pendle (PT/YT), Yield-Aggregatoren, konservative Portfolio-Strategien
...
- Liquid Staking Token (LST): stETH, rETH, sfrxETH
- Liquid Restaking Token (LRT): ezETH, eETH, rsETH
- AVS (Actively Validated Service)
- Yield Source Breakdown: Protokoll-Fees, Emissionen, Real Yield, Points
- Sustainable vs. Temporary Yield
- Principal Token (PT), Yield Token (YT), Pendle-Architektur
- Smart Contract Risk, Depeg Risk, Composability Risk, Dependency Risk
- Total Value Locked (TVL)

**Querverweise:**
- Die Unterscheidung zwischen Sustainable Yield (echte Gebühren) und Temporary Yield (Token-Emissionen) ist eine modulspezifische Fix-Doc-Erweiterung und zieht sich durch alle Lektionen.
- Liquid Staking als Baustein wurde in den Modulen 1, 5, 6 und 7 vorgestellt; hier wird es tief analysiert.
- Pendles Yield-Handel baut auf der Stablecoin-Mechanik aus Modul 8 auf und bereitet Modul 10 (Leverage-Loops) vor.
...
- Die Peg-Mechanik und historische Depeg-Events (stETH Juni 2022) als praktische Risiko-Indikatoren bewerten
- Die Governance-Strukturen von Lido, Rocket Pool und Frax in ihrer Auswirkung auf Protokoll-Risiken analysieren
- Die Composability von LSTs in Lending, LP und Restaking als strategischen Hebel und als Risiko-Amplifier einordnen
...
- Die AVS-Architektur (Actively Validated Services) als Grundlage für mehrfache Sicherheitsnutzung verstehen
- Points-basierte Yield-Systeme kritisch bewerten (Unsicherheit, Verwässerungs-Risiko, Timing-Risiko)
- Ein Restaking-Portfolio mit klaren Grenzen (kleine Allokation, bewusste Protokoll-Auswahl) aufbauen
...
- Die Zusatzschicht (Smart Contract Risk, Kurator-Risiko) von Aggregator-Strategien korrekt bewerten
- Die Kostenstruktur (Performance Fees, Withdrawal Fees, Gas) in der Netto-Renditekalkulation berücksichtigen
- Eine Vault-Due-Diligence (TVL, Strategy, Audit, Kurator-Historie) standardisiert durchführen
