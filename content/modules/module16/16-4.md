...
**[Slide 2]**
Heatmap-Style-Tabelle. Y-Achse: Einzel-Protokoll-Sicherheit (99 %, 98 %, 95 %, 90 %). X-Achse: Anzahl Layer (1, 2, 3, 4, 5, 8). Zellen: Aggregate Überlebens-Wahrscheinlichkeit, eingefärbt von Grün (>95 %) über Gelb (80–95 %) zu Rot (Werte unter 80 %). Die "95 %"-Zeile deutlich hervorgehoben mit Label: "Realistische DeFi-Welt".
