...
3. Falls DEX-Oracle: Von welchem Pool, und welches TWAP-Fenster? Was ist die Liquidität dieses Pools? (Pool-Liquidität unter 10 Mio USD = Manipulations-Risiko.)
...
```
    ...
    [3] Liquidations-Trigger
         (Health Factor unter 1 bei Positionen mit engem Buffer)
                      ↓
