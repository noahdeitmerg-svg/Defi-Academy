...
3. **Utilization-Rate für USDC-Pool**: Nachhaltiger Bereich 60–85 %. Exit-Trigger: Utilization > 95 % (Liquiditäts-Crunch) oder unter 40 % (Protokoll verliert Nutzung).
...
- Nachhaltigkeits-Schwelle: > 0,5 (gesund), 0,2–0,5 (Früh-Phase), unter 0,2 (strukturell unnachhaltig)
...
- Beispiel NovaLend Hard-Trigger: TVL unter 100 Mio. USD, NOVA unter 0,40 USD, signifikanter Incident
...
- Ratio unter 0,2: Strukturell unnachhaltig, meistens Disqualifikation
