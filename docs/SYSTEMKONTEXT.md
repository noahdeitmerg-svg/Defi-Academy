...
| 2026-04-22 | **Video:** Pipeline-Defaults auf `generated-assets`; Gamma-Prompts gestrafft; PDF-Slicing ohne Poppler (PDF.js). **`npm run pipeline:sync-assets`**. **Modul 4 / Lektion 2** neu gerendert (Gamma-Visuals) → `public/videos/module4-4-2.mp4` + `public/posters/module4-4-2.jpg`; `config/lesson-audio-durations.json` (`module4/4-2` → 203 s). |
