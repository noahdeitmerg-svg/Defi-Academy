 ...
 *
 * Modul-Format in Einzeldatei (ohne "# Modul"):
 *   ## Folien-Zusammenfassung mit **[Slide N] — Titel**-Markern
 *   ## Sprechertext mit **[Slide N]**-Markern
 *   ## Visuelle Vorschläge mit **[Slide N]**-Zeilen
 *   → gleiche Logik wie module-parser.parseLesson (slides[] mit body/narration/visual).
 */

'use strict';

const { parseSlideBlocks } = require('./module-parser');
